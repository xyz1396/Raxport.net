...
![.FT1 Scan Demo](./src/FT1ScanDemo.png)
...
![.FT2 Scan Demo](./src/FT2ScanDemo.png)

### Compile it in Visual Studio

Raxport.net is developed under .NET 8 and relies on `ThermoFisher.CommonCore.RawFileReader.dll` and `ThermoFisher.CommonCore.Data.dll` from [RawFileReader](https://github.com/thermofisherlsms/RawFileReader). You can clone this project and compile it in Visual Studio. See the [note.md](./test/note.md) for additional details.
